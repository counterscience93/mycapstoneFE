            ...
            >
              ...
              <template v-slot:cell(action)="row">
                ...
                <b-button
                  ...
                  size="sm"
                  class="table-icon"
                  v-b-modal.check-disable
                  @click="getId(row.item.id)"
                  ><font-awesome-icon icon="trash-alt" />
                </b-button>
              </template>
            </b-table>
            <b-modal id="check-disable" centered @ok="disableTopic(rowItem)">
              <h4>
                You want to disable Topic? (Disable topic will not show Topic
                again !!!)
              </h4>
            </b-modal>
